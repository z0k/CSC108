# a simple gui that we could maybe use in Lab 2 for students to 
# try with their distance_converter.py solutions
# Michelle Craig
# July 6, 2012
...
Go back and look at the lab instructions.'''
    ...
    def create_widgets(self):
        ...
        km_enterbox.bind('<KP_Enter>', self.recalculate_miles)
        ...
        mile_enterbox.bind('<KP_Enter>', self.recalculate_kms)
